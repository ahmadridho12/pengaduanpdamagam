...
class PengaduanController extends Controller
{
    ...
    $query->orderBy('tgl_pengaduan', 'desc');
    ...
    public function storePengaduan(Request $request)
    {
        ...
        $validate = Validator::make($data, [
            ...
            'rayon' => ['nullable'], // Validasi rayon jika diperlukan
            'no_index' => ['nullable'],
        ]);
        ...
        $pengaduan = Pengaduan::create([
            'tgl_pengaduan' => date('Y-m-d H:i:s'), // Gunakan H:i:s untuk format waktu yang benar
            'nama' => $data['nama'],
            'no_hp' => $data['no_hp'],
            ...
            'rayon' => $data['rayon'] ?? '', // Simpan rayon, default kosong jika tidak ada
